...
class TestSuite(Base, BaseModel):
    ...
    git_repo_url = Column(String(500), nullable=False, comment="Git代码仓库地址")
    git_branch = Column(String(100), default="main", nullable=False, comment="Git分支")
    git_token = Column(Text, nullable=False, comment="Git登录Token")
